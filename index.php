                                                    ...
                                                    while ($itemTemp = $resultado->fetch_assoc()) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <p align='center'>
                                                                ...
                                                                <a class='btn btn-warning' href='Eliminar.php?id=" . $itemTemp['id'] . "' role='button'><i class='fas fa-trash-alt'></i>
                                                                </a>
                                                            </p>
                                                            </td>
                                                        </tr>
                ...
                <div class="login-form">
                    ...
                    <form action="Insertar.php" method="POST">
                        ...
                        <div class="form-group">
                            <input value="<?php
                                            $nombre = "";
                                            if (isset($_SESSION['mi_post']["nombre"])) {
                                                $nombre = $_SESSION['mi_post']["nombre"];
                                            }
                                            echo $nombre;
                        ...
                        <div class="form-group">
                            <input value="<?php
                                            $correo = "";
                                            if (isset($_SESSION['mi_post']["email"])) {
                                                $correo = $_SESSION['mi_post']["email"];
                                            }
                                            echo $correo;
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" id="sexo" name="sexo" value="M" <?php if (isset($_SESSION['mi_post']["sexo"]) == 'M') echo 'checked'; ?> required> Masculino
                            </label>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" id="sexo" name="sexo" value="F" <?php if (isset($_SESSION['mi_post']["sexo"]) == 'F') echo 'checked'; ?> required> Femenino
                            </label>
                        </div>
                        </br>
                        <label>
                        ...
                        <div class="form-group">
                            ...
                            if (!$resultado) {
                                ...
                                while ($itemTemp = $resultado->fetch_assoc()) {
                                    $selected = '';
                                    if ($_SESSION['mi_post']['area'] == $itemTemp['id']) {
                                        $selected = 'selected';
                                    }
                        ...
                        <div class="form-group">
                            <textarea class="form-control rounded-0" name="descripcion" id="descripcion" rows="3" placeholder="Descripción de la experiencia del empleado" required>
                            <?php
                            $descripcion = "";
                            if (isset($_SESSION["mi_post"]["descripcion"])) {
                                echo $descripcion = $_SESSION["mi_post"]["descripcion"];
                            }
                            ?> 
                             </textarea>
                        </div>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="boletin" value="1" id="boletin" <?php if (isset($_SESSION['mi_post']["boletin"]) == '1') echo 'checked'; ?>>
                        ...
                        <div class="form-check">
                            ...
                            if (!$resultado3) {
                                ...
                                while ($itemTemp3 = $resultado3->fetch_assoc()) {
                                    if (isset($itemTemp3['id'])) {
                                        $rol = $itemTemp3['id'];
                                        $cadena1 = $cadena1 . $rol;
                                    }
                                    ...
                                    if ($row == 0) {
                                        echo "
                                        <input class='form-check-input' type='checkbox' name='rol[]' value='" . $itemTemp3['id'] . "' id='rol'>
                                        ...
                                        do {
                                            ...
                                            if ($rol_id == $rol and !($check)) {
                                                echo "
                                            <input checked class='form-check-input' type='checkbox' name='rol[]' value='" . $itemTemp3['id'] . "' id='rol'>
                                            <label class='form-check-label' for='rol[]'>
                                                " . $itemTemp3['nombre'] . "
                                            </label>
                                            </br>";
